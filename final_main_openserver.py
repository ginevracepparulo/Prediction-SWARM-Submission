...
client = OpenAI(
  ...
  api_key="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",
)
...
# GROQ_API_KEY = os.environ.get("OpenAI_API_KEY", "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")
...
#         response = requests.post(self.datura_api_url, json=payload, headers=headers)
...
#             try:
#                 response = requests.post(self.datura_api_url, json=params, headers=headers)
...
#         system_context = """    You are an expert in identifying whether a tweet contains a prediction — either explicitly or implicitly — about a real-world, measurable future outcome that could plausibly be listed as a Polymarket market.

#     Polymarket markets are based on objective, verifiable events across domains such as:

#     - Politics: elections, legislation, geopolitical outcomes
#     - Crypto & Finance: ETH/BTC prices, interest rates, ETF approvals
#     - Macroeconomics: inflation (CPI), unemployment, economic reports
#     - Sports: game or championship winners, match results
#     - Tech & Culture: product launches, public figures' decisions, global events

#     A valid prediction may be a direct forecast, a confident speculation, or a strongly implied outcome. It must be:

#     ✅ Specific  
#     ✅ About the future  
#     ✅ Objectively verifiable  
#     ✅ Topically relevant to Polymarket domains

#     ---

#     Examples of valid predictions:
#     - “Ethereum will break $3,000 next week.”
#     - “Trump is going to win the election.”
#     - “CPI will be above 3.5% in March.”
#     - “The Lakers are taking the Finals this year.”

#     Examples of invalid predictions:
#     - “I like Solana more than ETH.” (opinion)
#     - “Will Trump win?” (question)
#     - “This is gonna be wild!” (vague sentiment)
#     - “Tesla's new ad is amazing” (not predictive or market-based)

#     ---

#     Only classify tweets that make or imply a measurable prediction relevant to a Polymarket-style market. Exclude jokes, general opinions, vague hopes, rhetorical questions, or unverifiable claims.
    
#     Below is a list of tweets. For each one, respond "Yes" if it contains a prediction about a real-world, measurable future outcome that could plausibly be listed as a Polymarket market (e.g., crypto prices, political events, economic data, sports outcomes, etc.). Otherwise, respond "No".

#     Examples:

#     Tweets:
#     1. Ethereum will cross $3,000 next week.  
#     2. I love Solana more than ETH.  
#     3. Trump is going to win the 2024 election.  
#     4. Will CPI go above 4%?  
#     5. Lakers are taking the championship this year.
...
# Now, analyze the following tweets, generate the output and respond only in this exact JSON format:
...
#             credibility_score = (verification_stats["true"] + verification_stats["uncertain"]) / verification_stats["total"]
#         else:
#             credibility_score = 0.0
...
#             model=MODEL_NAME,
#             messages=[
#                 {"role": "system", "content": "You are an AI analyst verifying Polymarket claims/predictions."},
...
#     llm_config = {
#         "config_list": [{"model": MODEL_NAME, "api_key": GROQ_API_KEY, "api_type": "groq"}],
#         "temperature": 0.3,
#         "functions": functions,
#     }
...
# 1. Find predictions on [specific topic]
# 2. Build profile for [@predictor_handle]
...
#     credibility_score = predictor_profiler.calculate_credibility_score("Polymarket", prediction_verifier)
