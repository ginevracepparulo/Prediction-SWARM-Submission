...
# Classes for PredictionFinder, PredictionVerifier, and PredictorProfiler
...
async def run_prediction_analysis(assistant, text_messages):
    # Create agents
...
if prompt := st.chat_input("Type your Query"):
    ...
    with st.chat_message("assistant"):
        ...
        response = asyncio.run(run_prediction_analysis(assistant, text_messages=text_messages))
